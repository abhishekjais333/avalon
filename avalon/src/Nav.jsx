  ...
  return (
    <div className=" relative w-full bg-white border border-black-500 ">
      ...
      <div className="inline-flex items-center space-x-2">
          ...
          <span className="font-bold text-lg">Gamify-LanG</span>

           </div>
        <div className="hidden lg:block">
          <ul className="ml-9 inline-flex space-x-8">
            {menuItems.map((item) => (
              <li key={item.name}>
                <a
                  href={item.href}
        ...
        <div className=" ml-9 mt-3 hidden lg:block">
          <span className="relative inline-block">
            <img
              className="h-12 w-12 rounded-full border brorder-black-600"
